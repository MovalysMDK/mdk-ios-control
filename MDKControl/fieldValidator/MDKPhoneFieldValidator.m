...
@implementation MDKPhoneFieldValidator

+(instancetype)sharedInstance{
    static MDKPhoneFieldValidator *instance = nil;
...
-(MDKInvalidPhoneNumberValueUIValidationError *)validate:(id)value withCurrentState:(NSDictionary *)currentState
                                          withParameters:(NSDictionary *)parameters {
    MDKInvalidPhoneNumberValueUIValidationError *result = nil;
    if([value isKindOfClass:[NSString class]] || [value isKindOfClass:[NSAttributedString class]]) {
        if(![self matchPattern:value]) {
            result = [[MDKInvalidPhoneNumberValueUIValidationError alloc]  initWithLocalizedFieldName:parameters[@"componentName"] technicalFieldName:parameters[@"componentName"]];
        }
    }
    return result;
}
