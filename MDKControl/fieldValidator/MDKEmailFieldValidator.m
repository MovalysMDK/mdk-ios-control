...
@implementation MDKEmailFieldValidator

+(instancetype)sharedInstance{
    static MDKEmailFieldValidator *instance = nil;
...
-(MDKInvalidEmailValueUIValidationError *)validate:(id)value withCurrentState:(NSDictionary *)currentState withParameters:(NSDictionary *)parameters {
    MDKInvalidEmailValueUIValidationError *result = nil;
    if([value isKindOfClass:[NSString class]] || [value isKindOfClass:[NSAttributedString class]]) {
        if(![self matchPattern:value]) {
            result = [[MDKInvalidEmailValueUIValidationError alloc] initWithLocalizedFieldName:parameters[@"componentName"] technicalFieldName:parameters[@"componentName"]];
        }
    }
    return result;
}
