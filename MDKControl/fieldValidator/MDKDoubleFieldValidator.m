...
@implementation MDKDoubleFieldValidator

+(instancetype)sharedInstance{
    static MDKDoubleFieldValidator *instance = nil;
...
-(MDKInvalidDoubleValueUIValidationError *)validate:(id)value withCurrentState:(NSDictionary *)currentState withParameters:(NSDictionary *)parameters {
    ...
    if(([value isKindOfClass:[NSString class]] || [value isKindOfClass:[NSAttributedString class]]) && ![value isEqualToString:@""]) {
