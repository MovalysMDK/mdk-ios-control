 ...
 */
FOUNDATION_EXPORT NSInteger const TOO_SHORT_LIST_UI_VALIDATION_ERROR_CODE;

/*!
 * @brief Specific localized description key.
 */
FOUNDATION_EXPORT NSString *const TOO_SHORT_LIST_UI_VALIDATION_ERROR_LOCALIZED_DESCRIPTION_KEY;

#import "MDKValidationError.h"

/*!
 * @class MDKTooShortListUIValidationError
 ...
 */
@interface MDKTooShortListUIValidationError : MDKValidationError
 ...
 * @return New instance of MDKTooShortListUIValidationError.
 */
