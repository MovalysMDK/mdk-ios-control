...
{
    self = [super initWithCode:INVALID_LOCATION_VALUE_UI_VALIDATION_ERROR_CODE
       localizedDescriptionKey:INVALID_LOCATION_VALUE_UI_VALIDATION_LOCALIZED_DESCRIPTION_KEY
