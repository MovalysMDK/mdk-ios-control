...
/*!
 * @brief Allow to display a NSURL
 */
...
IB_DESIGNABLE
@interface MDKUIInternalWebView : MDKUIWebView <MDKInternalComponent>
...
IB_DESIGNABLE
@interface MDKUIExternalWebView : MDKUIWebView <MDKExternalComponent>
