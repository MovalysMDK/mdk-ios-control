...
@implementation MDKSignatureHelper {
...
static inline MDKLine scaleLine(MDKLine line, float ratio) {
    line.from.x *= ratio;
    line.from.y *= ratio;
    line.to.x *= ratio;
    line.to.y *= ratio;
...
static inline MDKLine translateLine(MDKLine line, float x0, float y0) {
    line.from.x += x0;
    line.from.y += y0;
    line.to.x += x0;
    line.to.y += y0;
