...
/*!
 * @protocol MDKCreateEmailViewControllerDelegate
 * @brief A protocol delegate that specifies the methods that must implement
 * a view controller that allows to create and send an email.
 */
@protocol MDKCreateEmailViewControllerDelegate <NSObject>
@required
