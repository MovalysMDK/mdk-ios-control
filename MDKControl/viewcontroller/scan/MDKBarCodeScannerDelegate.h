...
// Custom imports
@class MDKBarCodeScannerDelegate;
 ...
 */
@protocol MDKBarCodeScannerProtocol <AVCaptureMetadataOutputObjectsDelegate>
 ...
 */
@property (nonatomic, strong) MDKBarCodeScannerDelegate *barCodeScannerDelegate;
 ...
 */
@interface MDKBarCodeScannerDelegate : NSObject
